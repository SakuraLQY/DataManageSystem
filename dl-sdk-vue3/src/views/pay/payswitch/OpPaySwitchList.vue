<template>
  <div>
    ...
    <!-- 表单区域 -->
    <OpPaySwitchModal ref="registerModal" @success="handleSuccess"></OpPaySwitchModal>
  </div>
</template>

<script lang="ts" name="oppayswitch-opPaySwitch" setup>
  import { ref, reactive, onMounted, onUnmounted } from 'vue';
  import { BasicTable, useTable, TableAction } from '/@/components/Table';
  import { useListPage } from '/@/hooks/system/useListPage';
  import { columns,options } from './OpPaySwitch.data';
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './OpPaySwitch.api';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import OpPaySwitchModal from './components/OpPaySwitchModal.vue'
  ...
  function func(record){
    return record.rangeTime instanceof Array?record.rangeTime.join('~'):record.rangeTime.replace(',','~');
  }
