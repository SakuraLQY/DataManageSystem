  ...
  <a-spin :spinning="confirmLoading">
    <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol">
      <a-row>
        ...
        <a-col :span="12">
          <a-form-item label="账号" v-bind="validateInfos.advertiserId">
            <a-input v-model:value="formData.advertiserId" maxLength="50" placeholder="长度限制50位" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <!-- <a-col :span="12">
          <a-form-item label="账号密码" v-bind="validateInfos.password">
            <a-input v-model:value="formData.password" placeholder="请输入账号密码" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col> -->
        <a-col :span="12">
        ...
        <a-col :span="12">
          <a-form-item label="账号所属应用" v-bind="validateInfos.appId">
	          <j-search-select v-model:value="formData.appId" dict="open_gateway.op_ks_put_account_app,app_name,id" placeholder="请选择账号所属应用" disabled="false"/>
          </a-form-item>
        </a-col>
        <a-col :span="12">
        ...
        <a-col :span="17" :pull="2" v-if="!props.formDisabled">
          <a-form-item label="游戏" v-bind="validateInfos.subGame">
            <a-space :size="15">
              <a-select v-model:value="gameId" style="width:200px" placeholder="请选择游戏" allowClear :disabled="disabled">
                <a-select-option
              ...
              <a-select  allowClear v-model:value="subGameId" style="width:200px" placeholder="请选择子游戏名" v-if="gameId !=='' && gameId !==undefined" :disabled="disabled">
                <a-select-option
              ...
              <a-select placeholder="请选择子游戏名" style="width:200px" v-model:value="subGameId" v-if="gameId ==='' || gameId ===undefined" required :disabled="disabled">
                <a-select-option
...
<script lang="ts" setup>
  ...
  import { saveOrUpdate,faList,addSecondAccount } from '../OpKsPutAccount.api';
  ...
  const validatorRules = {
    ...
    advertiserId: [{ required: true, message: '请输入账号!'},],
