<template>
  <a-spin :spinning="confirmLoading">
    <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol">
      <a-row>
        <a-col :span="24">
          <a-form-item label="广告类型" v-bind="validateInfos.dealId">
            <a-input v-model:value="formData.dealId" placeholder="请输入广告类型" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="起始日期" v-bind="validateInfos.startTime">
            <a-input v-model:value="formData.startTime" placeholder="请输入起始日期" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="结束日期" v-bind="validateInfos.endTime">
            <a-input v-model:value="formData.endTime" placeholder="请输入结束日期" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="24">
        ...
        <a-col :span="24">
          <a-form-item label="子游戏" v-bind="validateInfos.subGameId">
            <a-input v-model:value="formData.subGameId" placeholder="请输入子游戏" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="渠道子账号" v-bind="validateInfos.channelSubAccountId">
            <a-input v-model:value="formData.channelSubAccountId" placeholder="请输入渠道子账号" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="24">
        ...
        <a-col :span="24">
          <a-form-item label="渠道游戏包" v-bind="validateInfos.pkgId">
            <a-input v-model:value="formData.pkgId" placeholder="请输入渠道游戏包" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
      </a-row>
    </a-form>
...
<script lang="ts" setup>
  ...
  import { saveOrUpdate } from '../StatHour.api';
