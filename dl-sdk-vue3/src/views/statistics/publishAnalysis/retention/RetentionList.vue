        ...
        <a-row :gutter="24">
          ...
          <a-col :lg="8">
            <a-form-item label="归类方式">
              <j-search-select placeholder="请选择归类方式" v-model:value="queryParam.type"  dict="retention_type"  />
            </a-form-item>
          </a-col>
...
<script lang="ts" name="count-ctRole" setup>
  ...
  import { columns } from './Retention.data';
  import GameThirdMuchOptionForm from '/@/views/common/gameThirdMuchOptionForm.vue';
  import { queryRetentionList } from '/@/views/statistics/financeData/RoiData/CtDaily.api';
  ...
  const queryParam = ref<any>({type: 5, startTime: dateString, endTime: dateString});
  ...
  function searchReset() {
    queryParam.value = {type: 5, startTime: dateString, endTime: dateString};
    //刷新数据
    reload();
