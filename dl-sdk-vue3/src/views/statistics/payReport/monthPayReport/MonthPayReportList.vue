<template>
  <div>
    ...
    <!-- 表单区域 -->
    <MonthPayReportModal ref="registerModal" @success="handleSuccess"></MonthPayReportModal>
  </div>
</template>

<script lang="ts" name="888888888-monthPayReport" setup>
  import { ref, reactive } from 'vue';
  import { BasicTable, useTable, TableAction } from '/@/components/Table';
  import { useListPage } from '/@/hooks/system/useListPage';
  import { columns } from './MonthPayReport.data';
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './MonthPayReport.api';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import MonthPayReportModal from './components/MonthPayReportModal.vue';
