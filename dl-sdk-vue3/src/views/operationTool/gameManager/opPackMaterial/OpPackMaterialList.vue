  ...
  <div>
        ...
        <a-row :gutter="24">
          ...
          <a-col :lg="8">
            <a-form-item label="素材类型">
              <j-dict-select-tag placeholder="请选择素材类型" v-model:value="queryParam.type" dictCode="material_type" allowClear/>
            </a-form-item>
          </a-col>
    ...
    <BasicTable @register="registerTable" :rowSelection="rowSelection">
      <template #materialContent="{ record }">
        <Tag color="green">
          <img :src="getImage(record.showUrl)"    min-width="70" height="70" />
        </Tag>
      </template>
    ...
    <!-- 表单区域 -->
    <OpPackMaterialModal ref="registerModal" @success="handleSuccess"></OpPackMaterialModal>
  </div>
</template>

<script lang="ts" name="game-opPackMaterial" setup>
  import { ref, reactive, watch, onMounted, onUnmounted } from 'vue';
  import { BasicTable, useTable, TableAction } from '/@/components/Table';
  import { useListPage } from '/@/hooks/system/useListPage';
  import { columns } from './OpPackMaterial.data';
  import { list, readPhoto, deleteOne, batchDelete, getImportUrl, getExportUrl } from './OpPackMaterial.api';
  import { optionList } from '../opSubGame/OpSubGame.api';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import OpPackMaterialModal from './components/OpPackMaterialModal.vue'
