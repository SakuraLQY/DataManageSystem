...
<script lang="ts" name="userPayRate" setup>
  import { ref, reactive } from 'vue';
  import { BasicTable, useTable, TableAction } from '/@/components/Table';
  import { useListPage } from '/@/hooks/system/useListPage';
  import { columns } from './UserPayRate.data';
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './UserPayRate.api';
