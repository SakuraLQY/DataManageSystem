...
public class OpJrttAudienceDto implements Serializable {
    ...
    private RetargetingTagsConfConfig retargetingTagsConf;
	/**穿山甲媒体定向*/
    ...
    private AwemeFanConfConfig awemeFanConf;
	/**过滤高活跃用户*/
    ...
    private InterestActionConfConfig interestActionConf;
	/**districtConf*/
    @ApiModelProperty(value = "districtConf")
    private DistrictConfConfig districtConf;
	/**定向逻辑和排除定向逻辑*/
    @ApiModelProperty(value = "定向逻辑和排除定向逻辑")
    private SuperiorPopularityTypeConfConfig superiorPopularityTypeConf;
	/**过滤已转化用户*/
