  ...
  <div>
    ...
    <div class="jeecg-basic-table-form-container">
      <a-form @keyup.enter.native="searchQuery" :model="queryParam" :label-col="labelCol" :wrapper-col="wrapperCol">
        <a-row :gutter="24">
          <a-col :lg="24">
            <div style="color: red; text-align: right; font-size: 20px">选取到渠道游戏包名才有用</div>
          </a-col>
          ...
          <a-col :lg="8">
            <a-form-item label="设备类型">
              <j-dict-select-tag v-model:value="queryParam.uniqueType" :options="uniqueType" :showChooseOption="false" />
            </a-form-item>
          </a-col>
          <a-col :lg="8">
            <a-form-item label="渠道名">
              <j-search-select v-model:value="queryParam.channelId" dict="open_gateway.op_channel ,channel_name,id" allowClear />
            </a-form-item>
          </a-col>
          <a-col :lg="8">
    ...
    <!-- 表单区域 -->
    <CallbackDataModal ref="registerModal" @success="handleSuccess"></CallbackDataModal>
  </div>
</template>

<script lang="ts" name="CallbackData-callbackData" setup>
  import { ref, reactive } from 'vue';
  import { BasicTable, useTable, TableAction } from '/@/components/Table';
  import { useListPage } from '/@/hooks/system/useListPage';
  import { columns, tableName, uniqueType } from './CallbackData.data';
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './CallbackData.api';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import CallbackDataModal from './components/CallbackDataModal.vue';
