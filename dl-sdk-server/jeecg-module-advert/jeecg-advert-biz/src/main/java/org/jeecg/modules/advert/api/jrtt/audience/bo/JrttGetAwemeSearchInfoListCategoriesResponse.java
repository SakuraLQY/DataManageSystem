...
/**
 * @Description: 查询抖音帐号和类目信息-list-categories  响应参数
 * @Author: lili
 * @Date: 2023-02-13
 * @Version: V1.0
 */
@Data
public class JrttGetAwemeSearchInfoListCategoriesResponse {
    ...
    private List<JrttGetAwemeSearchInfoListCategoriesResponse> children;
