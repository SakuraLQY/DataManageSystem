<template>
  <div>
    ...
    <!-- 表单区域 -->
    <LtvAnalysisModal ref="registerModal" @success="handleSuccess"></LtvAnalysisModal>
  </div>
</template>

<script lang="ts" name="count-ltvAnalysis" setup>
  import { ref, reactive } from 'vue';
  import { BasicTable, useTable, TableAction } from '/@/components/Table';
  import { useListPage } from '/@/hooks/system/useListPage';
  import { columns,typeOption } from './LtvAnalysis.data';
  import { queryList, deleteOne, batchDelete, getImportUrl, getExportUrl } from './LtvAnalysis.api';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import LtvAnalysisModal from './components/LtvAnalysisModal.vue'
