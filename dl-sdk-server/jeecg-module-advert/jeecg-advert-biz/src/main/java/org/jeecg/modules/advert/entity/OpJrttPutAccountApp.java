 ...
 */
@Data
@TableName("op_jrtt_put_account_app")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="op_jrtt_put_account_app对象", description="op_jrtt_put_account_app")
public class OpJrttPutAccountApp implements Serializable {
