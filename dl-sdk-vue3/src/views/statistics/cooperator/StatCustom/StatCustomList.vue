<template>
  <div>
    ...
    <BasicTable @register="registerTable">
      <!--插槽:table标题-->
      <template #tableTitle> <a-button type="primary" preIcon="ant-design:export-outlined" @click="onExportXls"> 导出</a-button> </template>
      <!--操作栏-->
...
<script lang="ts" name="count-ctRole" setup>
  ...
  import { queryStatCustomList, getstatCustomListexportXls } from '/@/views/statistics/financeData/RoiData/CtDaily.api';
  ...
  const { prefixCls, tableContext, onExportXls, onImportXls } = useListPage({
    ...
    exportConfig: {
      name: '合作商数据【数据】',
      url: getstatCustomListexportXls,
