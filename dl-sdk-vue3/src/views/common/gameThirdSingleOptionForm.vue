<template>
    ...
    <a-col :lg="8">
        <a-form-item label="渠道游戏包名">
            <a-select v-model:value="queryParam.pkgId" optionFilterProp="label" show-search allowClear placeholder="请选择渠道游戏包名" v-if="queryParam.gameId !=='' && queryParam.gameId !==undefined && queryParam.subGameId !=='' && queryParam.subGameId !==undefined">
            <a-select-option
