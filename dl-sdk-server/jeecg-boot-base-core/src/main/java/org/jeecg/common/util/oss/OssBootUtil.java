...
public class OssBootUtil {
    ...
    private static String packMaterialUrl;
    ...
    public static void setCdnUrl(String cdnUrl) {
        OssBootUtil.cdnUrl = cdnUrl;
    }

    public static void setPrivacyPolicyUrl(String privacyPolicyUrl) {
        OssBootUtil.privacyPolicyUrl = privacyPolicyUrl;
    }

    public static void setPackMaterialUrl(String packMaterialUrl) {
        OssBootUtil.packMaterialUrl = packMaterialUrl;
    }
    ...
    public static String getPackMaterialUrl() {
        return packMaterialUrl;
    }
