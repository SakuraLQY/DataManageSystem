       ...
       <a-col :span="24">
        ...
        <a-col :span="24">
          <a-form-item label="主播">
            <j-search-select
              v-model:value="formData.anchorPlanId"
        ...
        <a-col :span="24">
          <a-form-item label="安卓下载链接">
            <a-textarea v-model:value="formData.androidUrl" placeholder="多端创建时使用" showCount :maxlength="255" auto-size :disabled="disabled"></a-textarea>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="IOS下载链接">
            <a-textarea v-model:value="formData.iosUrl" placeholder="多端创建时使用" showCount :maxlength="255" auto-size :disabled="disabled"></a-textarea>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="广告描述">
            <a-textarea v-model:value="formData.dealDesc" placeholder="请输入广告描述" showCount :maxlength="128" auto-size :disabled="disabled"></a-textarea>
          </a-form-item>
        </a-col>
      </a-row>
    </a-form>
...
<script lang="ts" setup>
  ...
  import { saveOrUpdate, pkgInfoList } from '../deal.api';
