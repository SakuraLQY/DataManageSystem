<template>
  <a-modal  :title="title" :maskClosable="false" :width="width" :body-style="bodystyle" :visible="visible" @ok="handleOk"   :okButtonProps="{ class: { 'jee-hidden': disableSubmit } }" @cancel="handleCancel" cancelText="关闭">
    <OpRegisterLoginSwitchForm ref="registerForm" @ok="submitCallback" :formDisabled="disableSubmit" :formBpm="false"></OpRegisterLoginSwitchForm>
  </a-modal>
</template>
...
<script lang="ts" setup>
  ...
  import OpRegisterLoginSwitchForm from './OpRegisterLoginSwitchForm.vue'
