<template>
  <div>
        ...
        <a-row :gutter="24">
          <!-- <a-col :lg="8">
            <a-form-item label="游戏">
              <a-cascader
              v-model:value="queryParam.pkgIds"
              :options="treeData"
    ...
    <!-- 表单区域 -->
    <OpPrivacyPolicyModal ref="registerModal" @success="handleSuccess"></OpPrivacyPolicyModal>
  </div>
</template>

<script lang="ts" name="privacyPolicy-opPrivacyPolicy" setup>
  import { ref, reactive, onMounted, onUnmounted } from 'vue';
  import { BasicTable, useTable, TableAction } from '/@/components/Table';
  import JSearchSelect from '/@/components/Form/src/jeecg/components/JSearchSelect.vue';
  import { JAreaLinkage } from '/@/components/Form';
  import { useListPage } from '/@/hooks/system/useListPage';
  import { columns } from './OpPrivacyPolicy.data';
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './OpPrivacyPolicy.api';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import OpPrivacyPolicyModal from './components/OpPrivacyPolicyModal.vue';
