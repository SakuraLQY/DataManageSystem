...
<script lang="ts" name="count-ctUser" setup>
  ...
  const queryParam = ref<any>({type:1, startTime:dateString2, endTime: dateString});
  ...
  function searchReset() {
    queryParam.value = {type:1, startTime:dateString2, endTime: dateString};
