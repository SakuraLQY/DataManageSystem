<template>
  <div>
    ...
    <!-- 表单区域 -->
    <LogDeviceDataModal ref="registerModal" @success="handleSuccess"></LogDeviceDataModal>
  </div>
</template>

<script lang="ts" name="LogDeviceData-logDeviceData" setup>
  import { ref, reactive } from 'vue';
  import { BasicTable, useTable, TableAction } from '/@/components/Table';
  import { useListPage } from '/@/hooks/system/useListPage';
  import { columns } from './LogDeviceData.data';
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './LogDeviceData.api';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import LogDeviceDataModal from './components/LogDeviceDataModal.vue';
