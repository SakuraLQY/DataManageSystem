 ...
 */
@Data
@ApiModel(value="报表格式", description="报表格式")
public class XingtuDayReportModal implements Serializable {
    ...
    private String downloadRegRate;
    /**激活注册率*/
    ...
    private String costProbability;
    /**新增付费*/
