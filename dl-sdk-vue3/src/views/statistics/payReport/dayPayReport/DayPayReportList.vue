<template>
  <div>
    ...
    <!-- 表单区域 -->
    <DayPayReportModal ref="registerModal" @success="handleSuccess"></DayPayReportModal>
  </div>
</template>

<script lang="ts" name="dayreport-dayPayReport" setup>
  import { ref, reactive } from 'vue';
  import { BasicTable, useTable, TableAction } from '/@/components/Table';
  import { useListPage } from '/@/hooks/system/useListPage';
  import { columns } from './DayPayReport.data';
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './DayPayReport.api';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import DayPayReportModal from './components/DayPayReportModal.vue';
