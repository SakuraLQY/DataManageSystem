...
public class RestUtil {
    ...
    static {
        ...
        // 加入自定义信息转换
        RT.getMessageConverters().add(new MyMappingJackson2HttpMessageConverter());
    }
    ...
    public static <T> ResponseEntity<T> request(String url, HttpMethod method, HttpHeaders headers, JSONObject variables, Object params, Class<T> responseType) {
        ...
        if (params != null) {
            ...
            } else if (params instanceof LinkedMultiValueMap){
                body = params;
            }else {
        ...
        return RT.exchange(builder.build().toUri(), method, request, responseType);
    }
