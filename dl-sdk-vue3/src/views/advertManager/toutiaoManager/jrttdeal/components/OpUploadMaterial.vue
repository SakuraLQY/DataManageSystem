<template>
  <div class="material-div">
    <div style="text-align:center" v-if="materialManagerType == 2">{{ title }}</div>
    ...
    <a-button class="change-video-button" type="primary" v-if="materialManagerType == 2"
      @click="changeVideoCover">设置封面</a-button>
    <a-modal :visible="previewVisible" :footer="null" @cancel="handleCancel()">
      <img v-if="materialManagerType == 1" alt="example" style="width: 100%" :src="previewImage" />
      <video v-if="materialManagerType == 2" controls alt="example" style="width: 100%" :src="previewImage" />
    </a-modal>
    <!-- 选择素材弹窗 -->
    <a-modal title="选择素材" width="1000px" :visible="pictureListVisible" @cancel="handlePictureListCancel()" @ok="handleOk">
      <!--查询区域-->
      <div>
          ...
          <a-col style="padding-bottom: 30px" :span="6" v-for="item in imageList">
            ...
            <a-card :title="item.materialName" :class="{ on_unit: choosePic == item.showUrl }"
              ...
              <div class="template-thumb">
                <img v-if="materialManagerType == 1" alt="example" :src="getFileAccessHttpUrl(item.showUrl)" />
                <video v-if="materialManagerType == 2" controls alt="example" :src="getFileAccessHttpUrl(item.showUrl)" />
              </div>
            </a-card>
          </a-col>
        </a-row>
    ...
    <!-- 更换视频封面弹窗 -->
    <a-modal title="选择视频封面" width="1000px" :visible="screenshotListVisible" @ok="onClickScreenshotCard" @cancel="handlescreenshotCancel()">
...
export default defineComponent({
  ...
  setup(props, { emit, refs }) {
    ...
    // 素材表的type1
    const materialManagerType = props['materialManagerType'];
    // 素材表的type2
    ...
    async function onClickUpload() {
      if (uploadFileList.value.length == 0) {
        ...
        queryMaterialParam.value.type1 = props['materialManagerType'];
    ...
    async function handleOk() {
      ...
      if (props['materialManagerType'] == 2) {
        // 如果是视频类型需要取第一帧作为默认封面
